package com.asia_auto.server.gui.main;

import com.asia_auto.server.datafx.AnimatedFlowContainer;
import com.asia_auto.server.gui.uicomponents.ServerViewController;
...
//import client.datafx.AnimatedFlowContainer;
/**
 * Created by Игорь on 22.08.2016.
 */
@FXMLController(value = "/resources/fxml/ServerMainController.fxml")
public class ServerMainController {
    ...
    public void init() throws FlowException, VetoException {
        ...
        Flow innerFlow = new Flow(ServerViewController.class);
